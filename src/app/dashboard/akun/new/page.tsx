...
export default function AkunCreatePage() {
  const router = useRouter();
  const [form, setForm] = useState({ kode_akun: '', nama_akun: '', tipe: '', saldo_normal: '', status: true });
  ...
  async function submit() {
    ...
    try {
      if (!form.kode_akun || !form.nama_akun) { setError('Kode dan Nama wajib diisi'); setSaving(false); return; }
      await akunApi.create({
